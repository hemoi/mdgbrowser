...
struct OpenWebsiteIntent: AppIntent {
    ...
    static let description = IntentDescription(
        "Opens a website or search in Modot Browser.",
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        return .result(dialog: "Opening \(url.host() ?? website) in Modot Browser.")
    }
}

struct ModotBrowserShortcuts: AppShortcutsProvider {
